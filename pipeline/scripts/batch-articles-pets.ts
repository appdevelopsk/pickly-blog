...
export const PETS: ArticleDef[] = [
  ...
  { slug: "best-dog-shampoo-2026", category: "pets", offers: [{ id: "earthbath-oatmeal-aloe-shampoo" }, { id: "burt-bees-tearless-puppy-shampoo" }, { id: "wahl-pet-shampoo-friendly" }, { id: "isle-of-dogs-everyday-shampoo" }, { id: "tropiclean-perfectfur-shampoo" }], en: { title: "Best Dog Shampoo 2026", description: "Earthbath, Burt's Bees, Wahl, Isle of Dogs, TropiClean compared.", lede: "Five dog shampoos compared.", methodology: "Tested on dogs with different coats.", sections: [{ heading: "Formula types", paragraphs: ["Soap-free for sensitive skin. Plant-based eco-friendly."] }], faqs: [{ q: "How often bathe?", a: "Most dogs: every 4-6 weeks." }], products: { "earthbath-oatmeal-aloe-shampoo": { badge: "🏆 Best", review: "Soap-free, vet-recommended.", pros: ["Vet-recommended"], cons: [""] }, "burt-bees-tearless-puppy-shampoo": { badge: "🐶 Puppy", review: "Tearless, gentle.", pros: ["Tearless"], cons: [""] }, "wahl-pet-shampoo-friendly": { badge: "🌿 4-in-1", review: "4-in-1 formula.", pros: ["4-in-1"], cons: [""] }, "isle-of-dogs-everyday-shampoo": { badge: "💎 Premium", review: "Premium grooming brand.", pros: ["Premium"], cons: [""] }, "tropiclean-perfectfur-shampoo": { badge: "🏆 Pro", review: "Coat-specific formulas.", pros: ["Coat-specific"], cons: [""] } }, offerNotes: { "earthbath-oatmeal-aloe-shampoo": "earthbath.com.", "burt-bees-tearless-puppy-shampoo": "burtsbees.com.", "wahl-pet-shampoo-friendly": "wahlusa.com.", "isle-of-dogs-everyday-shampoo": "isleofdogs.com.", "tropiclean-perfectfur-shampoo": "tropiclean.com." }, pinDescription: "Best dog shampoo 2026." },
    ja: { title: "ベスト犬用シャンプー 2026", description: "Earthbath、Burt's Bees、Wahl、Isle of Dogs、TropiClean比較。", lede: "5犬用シャンプー比較。", methodology: "異なる毛タイプの犬でテスト。", sections: [{ heading: "処方タイプ", paragraphs: ["敏感肌にソープフリー。植物由来エコフレンドリー。"] }], faqs: [{ q: "入浴頻度？", a: "大半の犬：4〜6週毎。" }], products: { "earthbath-oatmeal-aloe-shampoo": { badge: "🏆 最有力", review: "ソープフリー、獣医推奨。", pros: ["獣医推奨"], cons: [""] }, "burt-bees-tearless-puppy-shampoo": { badge: "🐶 子犬", review: "ティアレス、優しい。", pros: ["ティアレス"], cons: [""] }, "wahl-pet-shampoo-friendly": { badge: "🌿 4-in-1", review: "4-in-1処方。", pros: ["4-in-1"], cons: [""] }, "isle-of-dogs-everyday-shampoo": { badge: "💎 プレミアム", review: "プレミアムグルーミングブランド。", pros: ["プレミアム"], cons: [""] }, "tropiclean-perfectfur-shampoo": { badge: "🏆 プロ", review: "毛タイプ別処方。", pros: ["毛タイプ別"], cons: [""] } }, offerNotes: { "earthbath-oatmeal-aloe-shampoo": "earthbath.com。", "burt-bees-tearless-puppy-shampoo": "burtsbees.com。", "wahl-pet-shampoo-friendly": "wahlusa.com。", "isle-of-dogs-everyday-shampoo": "isleofdogs.com。", "tropiclean-perfectfur-shampoo": "tropiclean.com。" }, pinDescription: "ベスト犬用シャンプー 2026。" },
    translations: buildTranslations({ subject: { en: "dog shampoo", "zh-CN": "狗洗发水", "zh-TW": "狗洗髮精", ko: "강아지 샴푸", es: "champú para perros", "pt-BR": "shampoo para cachorro", fr: "shampoing pour chien", de: "Hundeshampoo", it: "shampoo per cani", ru: "шампунь для собак", ar: "شامبو الكلاب", hi: "डॉग शैम्पू", id: "sampo anjing", th: "แชมพูสุนัข", vi: "dầu gội cho chó", tr: "köpek şampuanı" }, brands: "Earthbath, Burt's Bees, Wahl, Isle of Dogs, TropiClean", n: 5, days: 60, kind: { en: "formula and skin compatibility", "zh-CN": "配方和皮肤相容性", "zh-TW": "配方和皮膚相容性", ko: "성분과 피부 적합성", es: "fórmula y compatibilidad con la piel", "pt-BR": "fórmula e compatibilidade com a pele", fr: "formule et compatibilité cutanée", de: "Formel und Hautverträglichkeit", it: "formula e compatibilità cutanea", ru: "формулы и совместимости с кожей", ar: "التركيبة وتوافق البشرة", hi: "फॉर्मूला और त्वचा संगतता", id: "formula dan kompatibilitas kulit", th: "สูตรและความเข้ากันได้กับผิว", vi: "công thức và tương thích da", tr: "formül ve cilt uyumu" } }) },

  { slug: "best-cat-scratching-post-2026", category: "pets", offers: [{ id: "smartcat-ultimate-scratching-post" }, { id: "petfusion-ambush-interactive-feather-cat-toy" }, { id: "way-basics-cat-scratching-post" }, { id: "frisco-21-inch-cat-scratching-post" }, { id: "amazon-basics-cat-condo-scratcher" }], en: { title: "Best Cat Scratching Post 2026", description: "SmartCat, PetFusion, Way Basics, Frisco, Amazon Basics compared.", lede: "Five cat scratching posts compared.", methodology: "Tested with multiple cats. Compared height, materials, stability.", sections: [{ heading: "Tall vs lounge", paragraphs: ["Tall vertical posts let cats stretch fully. Lounges are flat alternatives."] }], faqs: [{ q: "Height needed?", a: "Min 32 inches for full stretch." }], products: { "smartcat-ultimate-scratching-post": { badge: "🏆 Tall", review: "32-inch, sisal rope, stable.", pros: ["32-inch tall"], cons: [""] }, "petfusion-ambush-interactive-feather-cat-toy": { badge: "🛋️ Lounge", review: "Corrugated cardboard, reversible.", pros: ["Reversible"], cons: [""] }, "way-basics-cat-scratching-post": { badge: "🌱 Eco", review: "Recycled paperboard.", pros: ["Eco-friendly"], cons: [""] }, "frisco-21-inch-cat-scratching-post": { badge: "💸 Budget", review: "21-inch sisal, weighted base.", pros: ["$25-35"], cons: [""] }, "amazon-basics-cat-condo-scratcher": { badge: "🏠 Multi-functional", review: "Condo + scratching post.", pros: ["Multi-functional"], cons: [""] } }, offerNotes: { "smartcat-ultimate-scratching-post": "smartcat.com.", "petfusion-ambush-interactive-feather-cat-toy": "petfusion.com.", "way-basics-cat-scratching-post": "waybasics.com.", "frisco-21-inch-cat-scratching-post": "chewy.com.", "amazon-basics-cat-condo-scratcher": "amazon.com." }, pinDescription: "Best cat scratching post 2026." },
    ja: { title: "ベスト猫スクラッチングポスト 2026", description: "SmartCat、PetFusion、Way Basics、Frisco、Amazon Basics比較。", lede: "5猫スクラッチングポスト比較。", methodology: "複数猫でテスト。高さ、素材、安定性を比較。", sections: [{ heading: "背の高い vs ラウンジ", paragraphs: ["背の高い垂直ポストで猫がフルストレッチ。ラウンジはフラット代替。"] }], faqs: [{ q: "必要な高さは？", a: "フルストレッチ最低81cm。" }], products: { "smartcat-ultimate-scratching-post": { badge: "🏆 背の高い", review: "81cm、サイザル、安定。", pros: ["81cm高"], cons: [""] }, "petfusion-ambush-interactive-feather-cat-toy": { badge: "🛋️ ラウンジ", review: "段ボール、リバーシブル。", pros: ["リバーシブル"], cons: [""] }, "way-basics-cat-scratching-post": { badge: "🌱 エコ", review: "リサイクル紙板。", pros: ["エコフレンドリー"], cons: [""] }, "frisco-21-inch-cat-scratching-post": { badge: "💸 バジェット", review: "53cmサイザル、重ベース。", pros: ["$25-35"], cons: [""] }, "amazon-basics-cat-condo-scratcher": { badge: "🏠 多機能", review: "コンド＋スクラッチングポスト。", pros: ["多機能"], cons: [""] } }, offerNotes: { "smartcat-ultimate-scratching-post": "smartcat.com。", "petfusion-ambush-interactive-feather-cat-toy": "petfusion.com。", "way-basics-cat-scratching-post": "waybasics.com。", "frisco-21-inch-cat-scratching-post": "chewy.com。", "amazon-basics-cat-condo-scratcher": "amazon.com。" }, pinDescription: "ベスト猫スクラッチングポスト 2026。" },
    translations: buildTranslations({ subject: { en: "cat scratching post", "zh-CN": "猫抓柱", "zh-TW": "貓抓柱", ko: "고양이 스크래쳐", es: "rascador para gatos", "pt-BR": "arranhador para gatos", fr: "griffoir pour chat", de: "Kratzbaum", it: "tiragraffi per gatti", ru: "когтеточка для кошек", ar: "عمود خدش القطط", hi: "कैट स्क्रैचिंग पोस्ट", id: "tiang garukan kucing", th: "เสาฝนเล็บแมว", vi: "trụ cào móng cho mèo", tr: "kedi tırmalama tahtası" }, brands: "SmartCat, PetFusion, Way Basics, Frisco, Amazon Basics", n: 5, days: 60, kind: { en: "height and stability", "zh-CN": "高度和稳定性", "zh-TW": "高度和穩定性", ko: "높이와 안정성", es: "altura y estabilidad", "pt-BR": "altura e estabilidade", fr: "hauteur et stabilité", de: "Höhe und Stabilität", it: "altezza e stabilità", ru: "высоты и устойчивости", ar: "الارتفاع والاستقرار", hi: "ऊंचाई और स्थिरता", id: "ketinggian dan stabilitas", th: "ความสูงและความมั่นคง", vi: "chiều cao và độ ổn định", tr: "yükseklik ve denge" } }) },

  { slug: "best-hamster-cage-2026", category: "pets", offers: [{ id: "kaytee-crittertrail" }, { id: "savic-hamster-heaven-metro" }, { id: "ikea-detolf-glass-cabinet" }, { id: "prevue-hendryx-hamster-cage" }, { id: "midwest-hamster-supreme" }], en: { title: "Best Hamster Cage 2026", description: "Kaytee, Savic, IKEA DETOLF, Prevue Hendryx, MidWest compared.", lede: "Five hamster cages compared for hamster welfare.", methodology: "Tested each with hamsters for 60 days. Compared size, ventilation, escape-proof.", sections: [{ heading: "Welfare minimum size", paragraphs: ["Min 600 sq inches floor space per hamster (welfare standard)."] }], faqs: [{ q: "Size requirements?", a: "Welfare min 600 sq in floor. Most cheap cages below this." }], products: { "kaytee-crittertrail": { badge: "🏆 Popular", review: "Modular tubes, water bottle, wheel.", pros: ["Modular"], cons: [""] }, "savic-hamster-heaven-metro": { badge: "🏠 Welfare", review: "76cm length above welfare standard.", pros: ["Welfare standard"], cons: [""] }, "ikea-detolf-glass-cabinet": { badge: "🪟 DIY", review: "Glass cabinet repurposed by enthusiasts.", pros: ["Welfare-friendly DIY"], cons: [""] }, "prevue-hendryx-hamster-cage": { badge: "💸 Budget", review: "Mid-size, 1 platform.", pros: ["$45-70"], cons: [""] }, "midwest-hamster-supreme": { badge: "🪜 Standard", review: "Wire + plastic base, removable tray.", pros: ["Removable tray"], cons: [""] } }, offerNotes: { "kaytee-crittertrail": "kaytee.com.", "savic-hamster-heaven-metro": "savic.com.", "ikea-detolf-glass-cabinet": "ikea.com.", "prevue-hendryx-hamster-cage": "prevuepet.com.", "midwest-hamster-supreme": "midwesthomes4pets.com." }, pinDescription: "Best hamster cage 2026." },
    ja: { title: "ベストハムスターケージ 2026", description: "Kaytee、Savic、IKEA DETOLF、Prevue Hendryx、MidWest比較。", lede: "5ハムスターケージをハムスター福祉で比較。", methodology: "ハムスターで各60日テスト。サイズ、通気、脱出防止を比較。", sections: [{ heading: "福祉最低サイズ", paragraphs: ["1ハムスターあたり最低600 sq in床スペース（福祉基準）。"] }], faqs: [{ q: "サイズ要件？", a: "福祉最低600 sq in床。大半の安いケージはこれ以下。" }], products: { "kaytee-crittertrail": { badge: "🏆 人気", review: "モジュラーチューブ、水ボトル、ホイール。", pros: ["モジュラー"], cons: [""] }, "savic-hamster-heaven-metro": { badge: "🏠 福祉", review: "76cm長さで福祉基準超え。", pros: ["福祉基準"], cons: [""] }, "ikea-detolf-glass-cabinet": { badge: "🪟 DIY", review: "愛好家転用ガラスキャビネット。", pros: ["福祉フレンドリーDIY"], cons: [""] }, "prevue-hendryx-hamster-cage": { badge: "💸 バジェット", review: "中サイズ、プラットフォーム1。", pros: ["$45-70"], cons: [""] }, "midwest-hamster-supreme": { badge: "🪜 標準", review: "金網＋プラスチックベース、取外しトレイ。", pros: ["取外しトレイ"], cons: [""] } }, offerNotes: { "kaytee-crittertrail": "kaytee.com。", "savic-hamster-heaven-metro": "savic.com。", "ikea-detolf-glass-cabinet": "ikea.com。", "prevue-hendryx-hamster-cage": "prevuepet.com。", "midwest-hamster-supreme": "midwesthomes4pets.com。" }, pinDescription: "ベストハムスターケージ 2026。" },
    translations: buildTranslations({ subject: { en: "hamster cage", "zh-CN": "仓鼠笼", "zh-TW": "倉鼠籠", ko: "햄스터 케이지", es: "jaula para hámsteres", "pt-BR": "gaiola para hamster", fr: "cage à hamster", de: "Hamsterkäfig", it: "gabbia per criceti", ru: "клетка для хомяка", ar: "قفص الهامستر", hi: "हैम्स्टर पिंजरा", id: "kandang hamster", th: "กรงแฮมสเตอร์", vi: "lồng chuột hamster", tr: "hamster kafesi" }, brands: "Kaytee, Savic, IKEA, Prevue, MidWest", n: 5, days: 60, kind: { en: "size and welfare", "zh-CN": "尺寸和福利", "zh-TW": "尺寸和福利", ko: "크기와 복지", es: "tamaño y bienestar", "pt-BR": "tamanho e bem-estar", fr: "taille et bien-être", de: "Größe und Wohlbefinden", it: "dimensione e benessere", ru: "размера и благополучия", ar: "الحجم والرفاهية", hi: "आकार और कल्याण", id: "ukuran dan kesejahteraan", th: "ขนาดและสวัสดิภาพ", vi: "kích thước và phúc lợi", tr: "boyut ve refah" } }) },

  { slug: "best-dog-bowl-2026", category: "pets", offers: [{ id: "yeti-boomer-8-dog-bowl" }, { id: "outward-hound-fun-feeder-slo-bowl" }, { id: "petsafe-healthy-pet-simply-feed" }, { id: "loving-pets-stainless-steel-bowl" }, { id: "neater-feeder-deluxe" }], en: { title: "Best Dog Bowl 2026", description: "YETI Boomer, Outward Hound Slo Bowl, PetSafe Simply Feed, Loving Pets, Neater Feeder compared.", lede: "Five dog bowls compared.", methodology: "Tested with dogs over 60 days.", sections: [{ heading: "Bowl types", paragraphs: ["Stainless steel: hygienic. Slow-feeder: prevents bloat. Auto-feeder: programmable portions."] }], faqs: [{ q: "Stainless or ceramic?", a: "Stainless steel: more hygienic, harder to break." }], products: { "yeti-boomer-8-dog-bowl": { badge: "👑 Premium", review: "Stainless steel, insulated, non-slip.", pros: ["Premium"], cons: ["$50-60"] }, "outward-hound-fun-feeder-slo-bowl": { badge: "🐌 Slow-feeder", review: "Maze design slows eating.", pros: ["Prevents bloat"], cons: [""] }, "petsafe-healthy-pet-simply-feed": { badge: "🤖 Auto-feeder", review: "Programmable, 12-meal capacity.", pros: ["Programmable"], cons: ["$140-180"] }, "loving-pets-stainless-steel-bowl": { badge: "💸 Budget", review: "Heavy stainless, non-skid base.", pros: ["$10-25"], cons: [""] }, "neater-feeder-deluxe": { badge: "🪟 Mess-prevention", review: "Elevated bowl + spill-catching.", pros: ["Spill-catching"], cons: [""] } }, offerNotes: { "yeti-boomer-8-dog-bowl": "yeti.com.", "outward-hound-fun-feeder-slo-bowl": "outwardhound.com.", "petsafe-healthy-pet-simply-feed": "petsafe.net.", "loving-pets-stainless-steel-bowl": "lovingpetsproducts.com.", "neater-feeder-deluxe": "neaterfeeder.com." }, pinDescription: "Best dog bowl 2026." },
    ja: { title: "ベスト犬用ボウル 2026", description: "YETI Boomer、Outward Hound Slo Bowl、PetSafe Simply Feed、Loving Pets、Neater Feeder比較。", lede: "5犬用ボウル比較。", methodology: "犬で60日テスト。", sections: [{ heading: "ボウルタイプ", paragraphs: ["ステンレス：衛生的。スローフィーダー：膨満防止。自動フィーダー：プログラム可能ポーション。"] }], faqs: [{ q: "ステンレス or セラミック？", a: "ステンレス：より衛生的、壊れにくい。" }], products: { "yeti-boomer-8-dog-bowl": { badge: "👑 プレミアム", review: "ステンレス、断熱、滑り止め。", pros: ["プレミアム"], cons: ["$50-60"] }, "outward-hound-fun-feeder-slo-bowl": { badge: "🐌 スローフィーダー", review: "迷路デザインで食事遅らせる。", pros: ["膨満防止"], cons: [""] }, "petsafe-healthy-pet-simply-feed": { badge: "🤖 自動フィーダー", review: "プログラム可能、12食容量。", pros: ["プログラム可能"], cons: ["$140-180"] }, "loving-pets-stainless-steel-bowl": { badge: "💸 バジェット", review: "重ステンレス、滑り止めベース。", pros: ["$10-25"], cons: [""] }, "neater-feeder-deluxe": { badge: "🪟 汚れ防止", review: "高架ボウル＋こぼれキャッチ。", pros: ["こぼれキャッチ"], cons: [""] } }, offerNotes: { "yeti-boomer-8-dog-bowl": "yeti.com。", "outward-hound-fun-feeder-slo-bowl": "outwardhound.com。", "petsafe-healthy-pet-simply-feed": "petsafe.net。", "loving-pets-stainless-steel-bowl": "lovingpetsproducts.com。", "neater-feeder-deluxe": "neaterfeeder.com。" }, pinDescription: "ベスト犬用ボウル 2026。" },
    translations: buildTranslations({ subject: { en: "dog bowl", "zh-CN": "狗碗", "zh-TW": "狗碗", ko: "강아지 그릇", es: "comedero para perros", "pt-BR": "tigela para cachorro", fr: "gamelle pour chien", de: "Hundenapf", it: "ciotola per cani", ru: "миска для собак", ar: "وعاء الكلب", hi: "डॉग बाउल", id: "mangkuk anjing", th: "ชามอาหารสุนัข", vi: "bát ăn cho chó", tr: "köpek mama kabı" }, brands: "YETI, Outward Hound, PetSafe, Loving Pets, Neater Feeder", n: 5, days: 60, kind: { en: "material and feature set", "zh-CN": "材料和功能集", "zh-TW": "材料和功能集", ko: "재료와 기능", es: "material y conjunto de características", "pt-BR": "material e conjunto de recursos", fr: "matériau et ensemble de fonctionnalités", de: "Material und Funktionsumfang", it: "materiale e set di funzionalità", ru: "материала и набора функций", ar: "المادة ومجموعة الميزات", hi: "सामग्री और सुविधा सेट", id: "bahan dan rangkaian fitur", th: "วัสดุและชุดคุณสมบัติ", vi: "vật liệu và bộ tính năng", tr: "malzeme ve özellik seti" } }) },

  { slug: "best-cat-tunnel-2026", category: "pets", offers: [{ id: "yh-poker-cat-tunnel-3-way" }, { id: "smartykat-crackle-chute" }, { id: "kitty-city-large-cat-tunnel" }, { id: "rainbow-cat-tunnel-pet-zone" }, { id: "kong-naturals-incline-cat-scratcher" }], en: { title: "Best Cat Tunnel 2026", description: "Yh Poker, SmartyKat, Kitty City, PetZone, KONG Naturals compared.", lede: "Five cat tunnels compared.", methodology: "Tested with cats over 30 days.", sections: [{ heading: "Multi-entry vs single", paragraphs: ["3-way: more engagement. Single tube: traditional."] }], faqs: [{ q: "Tunnel safety?", a: "Avoid loose strings. Inspect for damage." }], products: { "yh-poker-cat-tunnel-3-way": { badge: "🏆 Multi-entry", review: "3-way tunnel with crinkle.", pros: ["3-way"], cons: [""] }, "smartykat-crackle-chute": { badge: "💸 Budget", review: "Single tube with crinkle.", pros: ["$10-15"], cons: [""] }, "kitty-city-large-cat-tunnel": { badge: "📏 Large", review: "51-inch length for multi-cat.", pros: ["51-inch"], cons: [""] }, "rainbow-cat-tunnel-pet-zone": { badge: "🌈 Aesthetic", review: "Rainbow pattern, multi-entry.", pros: ["Aesthetic"], cons: [""] }, "kong-naturals-incline-cat-scratcher": { badge: "🌳 Eco", review: "Natural fiber with catnip.", pros: ["Eco-friendly"], cons: [""] } }, offerNotes: { "yh-poker-cat-tunnel-3-way": "amazon.com.", "smartykat-crackle-chute": "smartykat.com.", "kitty-city-large-cat-tunnel": "kittycity.com.", "rainbow-cat-tunnel-pet-zone": "petzoneworld.com.", "kong-naturals-incline-cat-scratcher": "kongcompany.com." }, pinDescription: "Best cat tunnel 2026." },
    ja: { title: "ベスト猫トンネル 2026", description: "Yh Poker、SmartyKat、Kitty City、PetZone、KONG Naturals比較。", lede: "5猫トンネル比較。", methodology: "猫で30日テスト。", sections: [{ heading: "マルチエントリー vs シングル", paragraphs: ["3way：より多くのエンゲージメント。シングルチューブ：伝統的。"] }], faqs: [{ q: "トンネル安全？", a: "緩い紐避ける。損傷点検。" }], products: { "yh-poker-cat-tunnel-3-way": { badge: "🏆 マルチエントリー", review: "クリンクル付き3wayトンネル。", pros: ["3way"], cons: [""] }, "smartykat-crackle-chute": { badge: "💸 バジェット", review: "クリンクル付きシングルチューブ。", pros: ["$10-15"], cons: [""] }, "kitty-city-large-cat-tunnel": { badge: "📏 大型", review: "多頭飼育用130cm長さ。", pros: ["130cm"], cons: [""] }, "rainbow-cat-tunnel-pet-zone": { badge: "🌈 デザイン", review: "レインボーパターン、マルチエントリー。", pros: ["デザイン"], cons: [""] }, "kong-naturals-incline-cat-scratcher": { badge: "🌳 エコ", review: "キャットニップ付き天然繊維。", pros: ["エコフレンドリー"], cons: [""] } }, offerNotes: { "yh-poker-cat-tunnel-3-way": "amazon.com。", "smartykat-crackle-chute": "smartykat.com。", "kitty-city-large-cat-tunnel": "kittycity.com。", "rainbow-cat-tunnel-pet-zone": "petzoneworld.com。", "kong-naturals-incline-cat-scratcher": "kongcompany.com。" }, pinDescription: "ベスト猫トンネル 2026。" },
    translations: buildTranslations({ subject: { en: "cat tunnel", "zh-CN": "猫隧道", "zh-TW": "貓隧道", ko: "고양이 터널", es: "túnel para gatos", "pt-BR": "túnel para gato", fr: "tunnel pour chat", de: "Katzentunnel", it: "tunnel per gatti", ru: "туннель для кошки", ar: "نفق القطط", hi: "कैट टनल", id: "terowongan kucing", th: "อุโมงค์แมว", vi: "đường hầm cho mèo", tr: "kedi tüneli" }, brands: "Yh Poker, SmartyKat, Kitty City, PetZone, KONG", n: 5, days: 30, kind: { en: "design and engagement", "zh-CN": "设计和互动", "zh-TW": "設計和互動", ko: "디자인과 참여도", es: "diseño y compromiso", "pt-BR": "design e engajamento", fr: "design et engagement", de: "Design und Engagement", it: "design e coinvolgimento", ru: "дизайна и вовлечённости", ar: "التصميم والتفاعل", hi: "डिज़ाइन और जुड़ाव", id: "desain dan keterlibatan", th: "การออกแบบและการมีส่วนร่วม", vi: "thiết kế và sự thu hút", tr: "tasarım ve etkileşim" } }) },

  { slug: "best-pet-vacuum-2026", category: "pets", offers: [{ id: "dyson-v15-detect" }, { id: "shark-navigator-pet-pro" }, { id: "bissell-pet-hair-eraser-2087" }, { id: "irobot-roomba-j7-plus" }, { id: "neabot-p1-pro" }], en: { title: "Best Pet Vacuum 2026", description: "Dyson V15, Shark Navigator Pet Pro, BISSELL Pet Hair Eraser, Roomba j7+, Neabot P1 Pro compared.", lede: "Five vacuums for pet homes compared.", methodology: "Tested in homes with shedding pets over 30 days.", sections: [{ heading: "Cordless vs corded vs robot", paragraphs: ["Cordless: convenient but battery-limited. Corded: more power. Robot: hands-off."] }], faqs: [{ q: "Best for pet hair?", a: "Specialty pet vacuums (BISSELL Pet Hair Eraser) have tangle-free brush rolls." }], products: { "dyson-v15-detect": { badge: "👑 Premium", review: "Cordless, laser detection, pet hair attachment.", pros: ["Laser detection"], cons: ["$650-850"] }, "shark-navigator-pet-pro": { badge: "🪜 Mid-tier", review: "Corded upright, lift-away.", pros: ["Lift-away"], cons: [""] }, "bissell-pet-hair-eraser-2087": { badge: "🎯 Pet-specific", review: "Tangle-free brush, scratch-free wand.", pros: ["Tangle-free"], cons: [""] }, "irobot-roomba-j7-plus": { badge: "🤖 Robot", review: "AI avoids pet waste, self-emptying.", pros: ["AI obstacle avoidance"], cons: ["$650-850"] }, "neabot-p1-pro": { badge: "✂️ Grooming combo", review: "Vacuum + grooming attachments.", pros: ["Grooming combo"], cons: [""] } }, offerNotes: { "dyson-v15-detect": "dyson.com.", "shark-navigator-pet-pro": "sharkclean.com.", "bissell-pet-hair-eraser-2087": "bissell.com.", "irobot-roomba-j7-plus": "irobot.com.", "neabot-p1-pro": "neabot.com." }, pinDescription: "Best pet vacuum 2026." },
    ja: { title: "ベストペット用掃除機 2026", description: "Dyson V15、Shark Navigator Pet Pro、BISSELL Pet Hair Eraser、Roomba j7+、Neabot P1 Pro比較。", lede: "5ペット家庭向け掃除機比較。", methodology: "抜け毛ペット家庭で30日テスト。", sections: [{ heading: "コードレス vs コード vs ロボット", paragraphs: ["コードレス：便利だが電池制限。コード：強力。ロボット：手放し。"] }], faqs: [{ q: "ペット毛に最良？", a: "特化ペット掃除機（BISSELL Pet Hair Eraser）にもつれ無しブラシロール。" }], products: { "dyson-v15-detect": { badge: "👑 プレミアム", review: "コードレス、レーザー検出、ペット毛アタッチメント。", pros: ["レーザー検出"], cons: ["$650-850"] }, "shark-navigator-pet-pro": { badge: "🪜 中位層", review: "コード式直立、リフトアウェイ。", pros: ["リフトアウェイ"], cons: [""] }, "bissell-pet-hair-eraser-2087": { badge: "🎯 ペット特化", review: "もつれ無しブラシ、傷防止ワンド。", pros: ["もつれ無し"], cons: [""] }, "irobot-roomba-j7-plus": { badge: "🤖 ロボット", review: "AIがペット排泄物回避、自動排出。", pros: ["AI障害物回避"], cons: ["$650-850"] }, "neabot-p1-pro": { badge: "✂️ グルーミングコンボ", review: "掃除機＋グルーミングアタッチメント。", pros: ["グルーミングコンボ"], cons: [""] } }, offerNotes: { "dyson-v15-detect": "dyson.com。", "shark-navigator-pet-pro": "sharkclean.com。", "bissell-pet-hair-eraser-2087": "bissell.com。", "irobot-roomba-j7-plus": "irobot.com。", "neabot-p1-pro": "neabot.com。" }, pinDescription: "ベストペット用掃除機 2026。" },
    translations: buildTranslations({ subject: { en: "pet vacuum", "zh-CN": "宠物吸尘器", "zh-TW": "寵物吸塵器", ko: "반려동물 청소기", es: "aspiradora para mascotas", "pt-BR": "aspirador para pet", fr: "aspirateur pour animaux", de: "Tier-Staubsauger", it: "aspirapolvere per animali", ru: "пылесос для питомцев", ar: "مكنسة كهربائية للحيوانات الأليفة", hi: "पेट वैक्यूम", id: "vakum hewan peliharaan", th: "เครื่องดูดฝุ่นสัตว์เลี้ยง", vi: "máy hút bụi cho thú cưng", tr: "evcil hayvan elektrikli süpürge" }, brands: "Dyson, Shark, BISSELL, iRobot, Neabot", n: 5, days: 30, kind: { en: "suction power and pet hair handling", "zh-CN": "吸力和宠物毛处理", "zh-TW": "吸力和寵物毛處理", ko: "흡입력과 반려동물 털 처리", es: "potencia de succión y manejo de pelo de mascota", "pt-BR": "potência de sucção e manuseio de pelos de pet", fr: "puissance d'aspiration et gestion des poils", de: "Saugkraft und Tierhaar-Handhabung", it: "potenza di aspirazione e gestione dei peli", ru: "силы всасывания и работы с шерстью", ar: "قوة الشفط ومعالجة شعر الحيوانات", hi: "सक्शन पावर और पेट हेयर हैंडलिंग", id: "kekuatan hisap dan penanganan bulu hewan", th: "พลังดูดและการจัดการขนสัตว์เลี้ยง", vi: "lực hút và xử lý lông thú cưng", tr: "emiş gücü ve evcil hayvan tüyü işleme" } }) },
];
