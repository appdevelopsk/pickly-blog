...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  beauty:    "Honest skincare and beauty product reviews — tested, not sponsored — for 2026.",
  home:      "Best home appliances, furniture, and décor products reviewed for 2026.",
  fashion:   "Top clothing, accessories, and footwear picks tested for quality and value.",
