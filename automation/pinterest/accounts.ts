...
export const ACCOUNTS: PinterestAccount[] = [
  ...
  {
    genre: "fashion",
    displayName: "Pickly Fashion",
    boardName: "Pickly Fashion Picks",
    boardBoards: ["fashion", "fashion-en", "fashion-ja"],
    envFile: path.join(os.homedir(), ".config/pickly/pinterest-fashion.env"),
    sessionDir: path.join(os.homedir(), ".cache/pickly-playwright/pinterest-fashion"),
  },
  {
    genre: "finance",
    displayName: "Pickly Finance",
    boardName: "Pickly Finance Picks",
    boardBoards: ["finance", "finance-en", "finance-ja"],
    envFile: path.join(os.homedir(), ".config/pickly/pinterest-finance.env"),
    sessionDir: path.join(os.homedir(), ".cache/pickly-playwright/pinterest-finance"),
  },
  {
    genre: "parenting",
    displayName: "Pickly Parenting",
    boardName: "Pickly Parenting Picks",
    boardBoards: ["parenting", "parenting-en", "parenting-ja", "baby", "baby-en", "baby-ja"],
    envFile: path.join(os.homedir(), ".config/pickly/pinterest-parenting.env"),
    sessionDir: path.join(os.homedir(), ".cache/pickly-playwright/pinterest-parenting"),
  },
  {
    genre: "pets",
    displayName: "Pickly Pets",
    boardName: "Pickly Pets Picks",
    boardBoards: ["pets", "pets-en", "pets-ja", "pet", "pet-en", "pet-ja"],
    envFile: path.join(os.homedir(), ".config/pickly/pinterest-pets.env"),
    sessionDir: path.join(os.homedir(), ".cache/pickly-playwright/pinterest-pets"),
  },
  {
    genre: "travel",
    displayName: "Pickly Travel",
    boardName: "Pickly Travel Picks",
    boardBoards: ["travel", "travel-en", "travel-ja"],
    envFile: path.join(os.homedir(), ".config/pickly/pinterest-travel.env"),
    sessionDir: path.join(os.homedir(), ".cache/pickly-playwright/pinterest-travel"),
  },
  {
